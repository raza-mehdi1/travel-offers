                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div class="card-tools">
                            <a class="btn btn-primary pull-right" href="{{route('images.create')}}">Upload New Image</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($images as $image)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('images.destroy', $image->id)}}" id="delete{{$image->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-danger" onclick='confirmDelete("{{$image->id}}", "Image")'>Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
