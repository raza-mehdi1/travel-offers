                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active"><a href="#">Package Includes</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div class="card-tools">
                            <a class="btn btn-primary pull-right" href="{{route('includes.create')}}">Create Package Include</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($includes as $include)
                                        <tr>
                                            <td>{!!$include->title!!}</td>
                                            <td>
                                                <a class="btn btn-primary" href="{{route('includes.edit', $include->id)}}">Edit</a>
                                            </td>
                                            <td>
                                                <form action="{{route('includes.destroy', $include->id)}}" id="delete{{$include->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-danger" onclick='confirmDelete("{{$include->id}}", "Itinerary Include")'>Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
