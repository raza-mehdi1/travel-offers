                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active"><a href="#">Package Features</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="card card-default">
                    <div class="card-header">
                        <div class="card-tools">
                            <a class="btn btn-primary pull-right" href="{{route('features.create')}}">Create Package Feature</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($features as $feature)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{route('features.destroy', $feature->id)}}" id="delete{{$feature->id}}" method="post">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="button" class="btn btn-danger" onclick='confirmDelete("{{$feature->id}}", "Itinerary Feature")'>Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
